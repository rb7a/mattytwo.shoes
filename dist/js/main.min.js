! function() {
    ...
    function a() {
        ...
        i.checked ? (n.classList.add("lights-off"), e && (e.innerHTML = "light")) : (n.classList.remove("lights-off"), e && (e.innerHTML = "dark"))
    }
    ...
    }), i && (window.addEventListener("onload", a), i.addEventListener("change", a))
}();